...
# with command line options: Configuration/GenProduction/python/BPH-RunIIFall17GS-00077-fragment.py --fileout file:BPH-RunIIFall17GS-00077.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --nThreads 8 --geometry DB:Extended --era Run2_2017 --python_filename BPH-RunIIFall17GS-00077_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 2336
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BPH-RunIIFall17GS-00077-fragment.py nevts:2336'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/EvtGenInterface/data/OniaAndX_mumu.dec')
        ),
...
#    MaxEta = cms.untracked.vdouble(2.5, 2.5),
    MaxInvMass = cms.untracked.double(6.0),
    #MinEta = cms.untracked.vdouble(-2.5, -2.5),
    MinInvMass = cms.untracked.double(1.0),
    MinP = cms.untracked.vdouble(0.0, 0.0),
    MinPt = cms.untracked.vdouble(1,1),#3.5,3.5), #(0.5, 0.5),
...
process.ProductionFilterSequence = cms.Sequence(process.generator#+process.bfilter
                                                +process.Jpsifilter+process.mumugenfilter)
