...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BPH-RunIIFall18GS-Bcchic2MuNu-fragment.py nevts:30'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_embedded = cms.vstring('\nAlias      thechi_c2 chi_c2\nChargeConj thechi_c2  thechi_c2\nAlias      theBc+  B_c+\nAlias      theBc-  B_c-\nChargeConj theBc-  theBc+\n#\nDecay theBc+\n  1.00000    thechi_c2  mu+            nu_mu         PHOTOS BC_VMN 2;\nEnddecay\nCDecay theBc-\n#\nEnd\n')
            ),
