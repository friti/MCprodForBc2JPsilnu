...
config.JobType.psetName = 'BTV-RunIISummer19UL18MiniAOD_-00025_1_cfg.py'

config.Data.inputDataset = input_dataset

config.JobType.inputFiles = ['run_crab_3.sh','BTV-RunIISummer19UL18RECO-00025_1_cfg.py','BTV-RunIISummer19UL18MiniAOD-00025_1_cfg.py']
config.JobType.scriptExe='run_crab_3.sh'
