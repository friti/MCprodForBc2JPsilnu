...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BPH-RunIIFall18GS-Bcchic1TauNu-fragment.py nevts:30'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_embedded = cms.vstring('\nAlias      thechi_c1 chi_c1\nChargeConj chi_c1  thechi_c1\nAlias      theBc+  B_c+\nAlias      theBc-  B_c-\nChargeConj theBc-  theBc+\n#\nDecay theBc+\n  1.00000    thechi_c1  tau+            nu_tau              PHOTOS BC_VMN 0;\nEnddecay\nCDecay theBc-\n#\nEnd\n')
            #user_decay_embedded = cms.vstring('\nAlias      thechi_c1 chi_c1\nChargeConj chi_c1  thechi_c1\nAlias      theBc+  B_c+\nAlias      theBc-  B_c-\nChargeConj theBc-  theBc+\n#\nDecay theBc+\n  1.00000    thechi_c1  tau+            nu_tau              PHOTOS ;\nEnddecay\nCDecay theBc-\n#\nEnd\n')
