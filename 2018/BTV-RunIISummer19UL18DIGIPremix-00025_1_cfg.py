...
# with command line options: step1 --fileout file:BTV-RunIISummer19UL18DIGIPremix-00025.root --pileup_input dbs:/Neutrino_E-10_gun/RunIISummer19ULPrePremix-UL18_106X_upgrade2018_realistic_v11_L1v1-v2/PREMIX --mc --eventcontent PREMIXRAW --runUnscheduled --datatier GEN-SIM-DIGI --conditions 106X_upgrade2018_realistic_v11_L1v1 --step DIGI,DATAMIX,L1,DIGI2RAW --procModifiers premix_stage2 --nThreads 8 --geometry DB:Extended --datamix PreMix --era Run2_2018 --python_filename BTV-RunIISummer19UL18DIGIPremix-00025_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 2000
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras
from Configuration.ProcessModifiers.premix_stage2_cff import premix_stage2

process = cms.Process('DIGI2RAW',eras.Run2_2018,premix_stage2)
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:BTV-RunIISummer19UL18DIGIPremix-00025.root'),
